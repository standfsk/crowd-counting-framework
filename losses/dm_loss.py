...
from .utils import _reshape_density, sinkhorn
    ...
    def forward(
        ...
        for idx, points in enumerate(target_points):
            if len(points) > 0:
                ...
                P, log = sinkhorn(target_prob, source_prob, dist, self.regularization, maxIter=self.num_of_iter_in_ot, log=True)
