...
class Backbone(nn.Module):
    def __init__(self, backbone: str, pretrained: bool = True):
        ...
        encoder = timm.create_model(backbone, pretrained=pretrained, features_only=True)
        feats = list(encoder.children())
        ...
        self.stem = nn.Sequential(*feats[0:3])
        self.stage1 = nn.Sequential(feats[3])
        self.stage2 = nn.Sequential(feats[4])
        self.stage3 = nn.Sequential(feats[5])
